...
export const EditableField: React.FC<EditableFieldProps> = ({
    ...
    return (
      <div className={`flex items-center gap-2 ${className}`}>
        <input
          ...
          min={minValue}
          max={maxValue}
          className={`flex-1 px-2 py-1 border border-blue-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${inputClassName}`}
        />
        <button
          onClick={handleSave}
  ...
  return (
    <div 
      className={`group flex items-center gap-2 cursor-pointer hover:bg-gray-50 rounded px-2 py-1 transition-colors ${className}`}
